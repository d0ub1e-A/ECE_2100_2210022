export default function DialogBox({ showDialog, setShowDialog, setShowForm }) {
  ...
  return (
    <div className={`fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 px-7 py-5 rounded-lg shadow-lg bg-slate-100 ${showDialog ? 'scale-100 skew-0' : 'scale-0 skew-12'} transition-all duration-400 z-50`}>
