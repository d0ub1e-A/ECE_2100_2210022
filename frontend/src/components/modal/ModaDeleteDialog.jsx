...
export default function DeleteDialog({deletableNoteId}) {
  ...
  return (
    <div className={`fixed top-1/2 left-1/2 -translate-x-1/2 px-15 py-10 rounded-lg dialog-box bg-slate-100 dark:bg-slate-600 ${showDeleteDialog ? 'opacity-100 -translate-y-1/2 z-30' : 'opacity-0 translate-y-10 z-0'} transition-all duration-400`}>
